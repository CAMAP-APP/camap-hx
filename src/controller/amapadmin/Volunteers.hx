...
class Volunteers extends controller.Controller
{
	...
	function doDefault() {
		...
		form.addElement( new IntInput("daysAfterClosingBeforeHidingDutyPeriods", t._("Hide volunteer shift for catalogs expired for more than … (days)"), userGroup.daysAfterClosingBeforeHidingDutyPeriods, true) );
