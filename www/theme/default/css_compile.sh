...
CAMAPDIR=$1
cat $CAMAPDIR/camap-hx/www/theme/default/css/variables.less | grep -v keyframes |  sed s/@/$/g > $CAMAPDIR/camap-hx/www/theme/default/css/style.scss
cat $CAMAPDIR/camap-hx/www/theme/default/css/bootswatch.scss >> $CAMAPDIR/camap-hx/www/theme/default/css/style.scss
